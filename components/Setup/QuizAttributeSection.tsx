...
export default function QuizAttributeSection({
  ...
  return (
    <Stack>
      ...
      />
      <NumberInput
        label="Number of Questions per Topic (1-5)"
        clampBehavior="strict"
        min={1}
        max={5}
        {...quesProps}
      ...
      {showIncludeExclude && (
        <>
          <TagsInput
            ...
            description="Requests that topics listed here inform the topics generated by AI"
            defaultValue={[]}
            clearable
            {...includeProps}
          />
          <TagsInput
            ...
            placeholder="USE ENTER to submit"
            description="Requests that topics listed here are avoided by AI"
            defaultValue={[]}
            clearable
            {...excludeProps}
          />
      ...
      {showExclusive && (
        <TagsInput
          ...
          placeholder="USE ENTER to submit"
          description="Requests questions on these topics, alone"
          defaultValue={[]}
          clearable
          {...exclusiveProps}
        />
